...
const Profile = () => {
  ...
  const { profile, recalcProfile } = useProfileState(profileData as any);
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <UploadPhotoModal
        ...
        onPickFromGallery={() => console.log("pick gallery")}
      ...
      >
        <ProfileHeaderParallax
          ...
          onEditPress={() => router.push("/jobseeker/EditProfile")}
        ...
        {/* PROFILE COMPLETION */}
        <View className="mx-4 mt-8 bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
              ...
              <Card title="Licenses & Certifications" icon="ribbon-outline">
                {profile.certifications.map((cert: any, i: number) => (
                  ...
                  >
                    ...
                    <Text className="text-gray-400 text-sm">{cert.year}</Text>
                  </TouchableOpacity>
                ))}
              ...
              {profile.roadmap.map((g: any, i: number) => (
                ...
                >
                  <View className="flex-row justify-between items-start mb-2">
                    <Text className="font-semibold text-lg w-1/2">
                      {g.title}
                    </Text>
                  ...
                  <Text className="text-gray-600 text-sm">{g.deadline}</Text>
